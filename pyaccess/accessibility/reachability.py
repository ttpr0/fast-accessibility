...
def calc_reachability(
    ...
    reachability = _pyaccess_ext.calc_reachability(solver, dem_nodes, sup_nodes, decay)
    return reachability

def calc_reachability_2(
        graph: Graph,
        dem_points: list[tuple[float, float]] | tuple[np.ndarray, np.ndarray] | gpd.GeoSeries,
        sup_points: list[tuple[float, float]] | tuple[np.ndarray, np.ndarray] | gpd.GeoSeries,
        decay: _pyaccess_ext.IDistanceDecay = _pyaccess_ext.BinaryDecay(900),
    ...
    reachability, reached_counts = _pyaccess_ext.calc_reachability_2(solver, dem_nodes, sup_nodes, decay)
    return reachability, reached_counts
