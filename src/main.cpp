...
int main()
{
    ...
    auto grasp_graph_1000 = loadTiledGraph(GRAPH_DIR + "/" + GRAPH_NAME + "_grasp_1000");
    cout << "finished loading grasp-graph 1000..." << endl;
    ...
    benchmark_one_to_many(ch_graph.get(), ch_graph_1000.get(), ch_graph_5000.get(), ch_graph_10000.get(), grasp_graph_1000.get(), grasp_graph_5000.get(), grasp_graph_10000.get(),
                          isophast_graph_1000.get(), isophast_graph_5000.get(), isophast_graph_10000.get());
