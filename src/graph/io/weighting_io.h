...
static std::shared_ptr<Weighting> load_edge_weights(const std::string& file)
{
...
static void store_edge_weights(Weighting& weight, const std::string& file)
{
...
static std::shared_ptr<TCWeighting> load_tc_weights(const std::string& file)
{
    auto arr = readAllFile(file);
    auto reader = BufferReader(arr);
...
static void store_tc_weights(TCWeighting& weight, const std::string& file)
{
    auto writer = BufferWriter();
